...
big_font = pygame.font.SysFont("chalkduster", 80)
    ...
    while run:
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.MOUSEBUTTONUP and \
                    (217 < pygame.mouse.get_pos()[0] < 284 and
                     533 < pygame.mouse.get_pos()[1] < 550):
        ...
        if selected_piece:
            move_msg = selected_piece.what_is_selected(window)
            game.draw_possible_moves(selected_piece, window)

        # Draw move message (confirming or showing why move can't be made)
